...
def feld_ausgabe(Zug_s):
    ...
    if spieler_aktuell == 'Spieler 1':
        zeichen = SPIELER_ZEICHEN
    elif spieler_aktuell == 'Spieler 2':
...
def Wechsel_Spieler(aktuell):
    global Modus
    global spieler_aktuell
    if aktuell == 'Spieler 1':
        if Modus == 1:
            spieler_aktuell = 'Spieler 2'
        else: 
            spieler_aktuell = 'Computer'        
    else:
        spieler_aktuell = 'Spieler 1'
...
def main():
    ...
    global Modus
    global spieler_aktuell
    Modus = int(input('Möchtest du gegen einen anderen Menschen (1) oder einen Computer (2) spielen? '))
    if Modus == 1:
        spieler_aktuell = 'Spieler 2'
    else: 
        spieler_aktuell = 'Computer'
    ...
    while spielen == True:
        ...
        if spieler_aktuell == 'Spieler 1':
            ...
            print(f'\nIhr Spielzug: {Zug_spieler+1} \n') 
        elif spieler_aktuell == 'Spieler 2':
            Zug_spieler = spieler_eingabe()             
            feld_ausgabe(Zug_spieler)
            print(f'\nSpieler 2 hat {Zug_spieler+1} gespielt\n')
        ...
        Wechsel_Spieler(spieler_aktuell)
